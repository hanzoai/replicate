# Replicate Architecture Reference

Condensed architectural reference for agents working on Replicate.

## System Layers

```
Application Layer    cmd/replicate/       CLI commands, YAML/env config
...
The heart of Replicate. Manages a single SQLite database.
